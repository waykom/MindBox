<template>
<uni-shadow-root class="vant-weapp-dist-overlay-index"><root-portal v-if="rootPortal">
...
global['__wxRoute'] = 'vant-weapp/dist/overlay/index'
...
export default global['__wxComponents']['vant-weapp/dist/overlay/index']
</script>
