<template>
<uni-shadow-root class="vant-weapp-dist-circle-index"><view class="van-circle">
...
global['__wxRoute'] = 'vant-weapp/dist/circle/index'
...
export default global['__wxComponents']['vant-weapp/dist/circle/index']
</script>
