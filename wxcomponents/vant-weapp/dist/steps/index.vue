<template>
<uni-shadow-root class="vant-weapp-dist-steps-index"><view :class="'custom-class '+(utils.bem('steps', [direction]))">
...
global['__wxRoute'] = 'vant-weapp/dist/steps/index'
...
export default global['__wxComponents']['vant-weapp/dist/steps/index']
</script>
