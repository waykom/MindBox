<template>
<uni-shadow-root class="vant-weapp-dist-slider-index"><view :class="'custom-class '+(utils.bem('slider', { disabled, vertical }))" :style="wrapperStyle" @click="onClick">
...
global['__wxRoute'] = 'vant-weapp/dist/slider/index'
...
export default global['__wxComponents']['vant-weapp/dist/slider/index']
</script>
