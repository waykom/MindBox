<template>
<uni-shadow-root class="vant-weapp-dist-rate-index"><view :class="(utils.bem('rate'))+' custom-class'" @touchmove="onTouchMove">
...
global['__wxRoute'] = 'vant-weapp/dist/rate/index'
...
export default global['__wxComponents']['vant-weapp/dist/rate/index']
</script>
