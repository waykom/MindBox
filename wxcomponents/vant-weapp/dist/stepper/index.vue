<template>
<uni-shadow-root class="vant-weapp-dist-stepper-index"><view :class="(utils.bem('stepper', [theme]))+' custom-class'">
...
global['__wxRoute'] = 'vant-weapp/dist/stepper/index'
...
export default global['__wxComponents']['vant-weapp/dist/stepper/index']
</script>
