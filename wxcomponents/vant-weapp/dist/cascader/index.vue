<template>
<uni-shadow-root class="vant-weapp-dist-cascader-index"><view v-if="showHeader" class="van-cascader__header">
...
global['__wxRoute'] = 'vant-weapp/dist/cascader/index'
...
export default global['__wxComponents']['vant-weapp/dist/cascader/index']
</script>
