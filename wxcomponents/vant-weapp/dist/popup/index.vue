<template>
<uni-shadow-root class="vant-weapp-dist-popup-index"><van-overlay v-if="overlay" :show="show" :z-index="zIndex" :custom-style="overlayStyle" :duration="duration" @click="onClickOverlay" :lock-scroll="lockScroll" :root-portal="rootPortal"></van-overlay>

<root-portal v-if="rootPortal">
  <include src="./popup.wxml"></include>
</root-portal>

 <include v-else src="./popup.wxml"></include></uni-shadow-root>
</template>
<wxs src="../wxs/utils.wxs" module="utils"></wxs><wxs src="./index.wxs" module="computed"></wxs>
<script>

const __wxTemplateComponentProps = {}
import __wxTemplateComponent0 from './popup.vue'

import VanIcon from '../icon/index.vue'
import VanOverlay from '../overlay/index.vue'
global['__wxVueOptions'] = {components:{'van-icon': VanIcon,'van-overlay': VanOverlay,}}

global['__wxRoute'] = 'vant-weapp/dist/popup/index'
...
export default global['__wxComponents']['vant-weapp/dist/popup/index']
</script>
