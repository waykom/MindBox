<template>
<uni-shadow-root class="vant-weapp-dist-tabs-index"><view :class="'custom-class '+(utils.bem('tabs'))">
...
global['__wxRoute'] = 'vant-weapp/dist/tabs/index'
...
export default global['__wxComponents']['vant-weapp/dist/tabs/index']
</script>
