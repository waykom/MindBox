<template>
<uni-shadow-root class="vant-weapp-dist-sticky-index"><view class="custom-class van-sticky" :style="computed.containerStyle({ fixed, height, zIndex })">
...
global['__wxRoute'] = 'vant-weapp/dist/sticky/index'
...
export default global['__wxComponents']['vant-weapp/dist/sticky/index']
</script>
