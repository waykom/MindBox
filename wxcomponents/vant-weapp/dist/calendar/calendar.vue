<template>
<uni-shadow-root class="vant-weapp-dist-calendar-calendar"><view class="van-calendar">
...
global['__wxRoute'] = 'vant-weapp/dist/calendar/calendar'

Component({})

export default global['__wxComponents']['vant-weapp/dist/calendar/calendar']
</script>
