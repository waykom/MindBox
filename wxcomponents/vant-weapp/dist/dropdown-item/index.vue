<template>
<uni-shadow-root class="vant-weapp-dist-dropdown-item-index"><view v-if="showWrapper" :class="(utils.bem('dropdown-item', direction))+' custom-class'" :style="wrapperStyle">
...
global['__wxRoute'] = 'vant-weapp/dist/dropdown-item/index'
...
export default global['__wxComponents']['vant-weapp/dist/dropdown-item/index']
</script>
