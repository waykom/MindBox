<template>
<uni-shadow-root class="vant-weapp-dist-dropdown-menu-index"><view class="van-dropdown-menu van-dropdown-menu--top-bottom custom-class">
...
global['__wxRoute'] = 'vant-weapp/dist/dropdown-menu/index'
...
export default global['__wxComponents']['vant-weapp/dist/dropdown-menu/index']
</script>
